...
export const SearchCom = (props) => {
  ...
  return (
    <div className="bg-white border  w-[577px] h-[130px] flex flex-row border-none p-4 ">
      <div>
        <div className="flex flex-row">
          <div className=" w-[67px] h-[100px] flex ml-4">
          ...
          <div className="flex flex-col ">
            <div className="flex flex-col ml-5 gap-1">
              ...
              <div className="flex justify-betwween gap-30 ">
                {date}
        ...
        <div className="w-140 h-0.5 bg-gray-300 mt-5"></div>
      </div>
    </div>
  );
};
