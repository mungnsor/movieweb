...
export const GenreList = () => {
  ...
  return (
    <div className="w-[577px] h-[330px] bg-white text-black rounded-lg border-none p-8 flex gap-5 flex-col max-sm:w-[335px] max-sm:h-[513px]">
      ...
      <div className="w-130 h-0.5 bg-gray-400 max-sm:w-70 "></div>
      <div className="flex flex-wrap gap-3 w-[537px] h-[200px] max-sm:w-[295px] max-sm:h-[380px]">
